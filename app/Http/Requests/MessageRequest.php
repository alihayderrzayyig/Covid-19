...
class MessageRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'desc'   => 'required|string|min:12|regex:/^[\p{L} ]+$/u',
    ...
    public function messages()
    {
        return [
            ...
            'desc.required'          => 'حقل التفاصيل مطلوب',
            'desc.string'            => 'حقل التفاصيل يجب ان يحتوي على نص',
            'desc.min'               => 'حقل التفاصيل يجب ان لا يقل عن 12 حر',
            'desc.regex'             => 'حقل التفاصيل يجب ان يتكون من الاحرف والمسافات فقط',
